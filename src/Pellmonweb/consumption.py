...
def make_barchart_string(db, end, align, div, bars, out='-', width=440, tot_txt='total', avg_unit='', tot_unit='kg', param=''):
    ...
    RrdGraphString1="LD_LIBRARY_PATH=/home/motoz/rrd /home/motoz/rrd/rrdtool graph "+consumption_file+" --border 0 --disable-rrdtool-tag --full-size-mode --width "+graphWidth+" %s --right-axis-format %%1.1lf --height 400 --end %u --start %u-%us "%(param,now,now,div*bars)
